...
def sign_in():
    ...
    sign_in = Label(root, text="SIGN IN", font=(
    ...
    signin_button = Button(root, text="SIGN IN", font=(
        "Code New Roman", 14, "bold"), bg="#0000cd", fg="white", width=15, command=validate_user)
