...
def sign_up():
    ...
    sign_label = Label(root, text="SIGN UP", font=(
        "Code New Roman", 24, "bold"), bg="white")
    ...
    signup_button = Button(root, text="SIGN UP", font=(
        "Code New Roman", 14, "bold"), bg="#50c878", fg="white", width=15, command=sign_up)
